...
## Description
This microservice allows deleting work teams in the system using a REST API. It is built with Golang, utilizing PostgreSQL as the database.
...
```sh
git clone https://github.com/Anggeloo/services-work-team-delete.git
cd services-work-team-delete
```
...
1. Build the Docker image:
   ```sh
   docker build -t services-work-team-delete .
   ```

2. Run the container:
   ```sh
   docker run -p 8183:8080 --env-file .env services-work-team-delete
   ```
